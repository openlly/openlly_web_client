  ...
  return (
    <div className="space-y-3 animate-fade-in">
      ...
      <div className="relative">
        ...
        required
      min={new Date(Date.now() + 2 * 60 * 1000).toISOString().slice(0, 16)}  // 2 minutes from now
      max={new Date(Date.now() + 48 * 60 * 60 * 1000).toISOString().slice(0, 16)} // 48 hours from now
      className="w-full pl-9 pr-10 py-2 rounded-lg bg-gray-50/50
        t ext-sm placeholder:text-gray-400
        focus:ring-2 focus:ring-[#ee0979]/20 border-0
        transition-all"
        />
